...
class Film_special:
    ...
    def film_search(self, keyword, encoding=None):
        ...
        regex = dict(
                ...
                info = '<li><span class="tt"></span><span class="xing_vb4"> <a href="(.*?)" target="_blank">(.*?)<font color="#FF0000">(.*?)</font>\s+?\
                <img class="new" src="/template/kuku/images/huo.gif"></span><span class="xing_vb51">(.*?)</span><span class="xing_vb54">(.*?)</span> <span class="xing_vb52">(.*?)</span> <span class="xing_vb53"><font color="#f60">(.*?)</font></span>  <span class="xing_vb6">(.*?)</span></a></li>'
...
if __name__ == '__main__':
    ...
    info = x.film_search('家有喜事') 
#    info2 = x.get_show_page_info(url)  
#    info3 = x.get_film_info(url2)A
